...
df = get_dataframe("/Users/robinjehn/Documents/repos/StarShooter/data/csv/")
data_set, mover_ids = get_dataset(
    df, "/Users/robinjehn/Documents/repos/StarShooter/data/30x30_images/"
)

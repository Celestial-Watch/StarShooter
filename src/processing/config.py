...
POS_MOVER_PATH = os.path.join(
    PROCESSING_PATH, "data/alistair/filtered_metadata_pos.csv"
)
NEG_MOVER_PATH = os.path.join(
    PROCESSING_PATH, "data/alistair/filtered_metadata_neg.csv"
)
ALL_MOVERS_PATH = os.path.join(
    PROCESSING_PATH, "data/alistair/filtered_metadata_all.csv"
)
